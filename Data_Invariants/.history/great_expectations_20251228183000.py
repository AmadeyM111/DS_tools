...
def get_config_from_env() -> dict:
    ...
    default_raw_data = PROJECT_ROOT.parent.parent / 'experimental' / 'data' / 'raw'
    default_clean_data = PROJECT_ROOT.parent.parent / 'experimental' / 'data' / 'processed'
...
def setup_great_expectations(config: dict) -> tuple:
    ...
    try:
        ...
        logger.info(f"Data Asset '{config['asset_name']}' успешно создан")
...
def create_expectations(context: gx.Context, data_asset) -> Optional[gx.ExpectationSuite]:
    """
...
def validate_data(context: gx.Context, data_asset, suite_name: str) -> Optional[gx.CheckpointResult]:
    """
